...
void SSD1306_initHard(void) {
    IIC_initHard();
}

void SSD1306_writeCmdHard(u8 u8cmd) {
    IIC_writeReg(WRITE_CMD_CMD, u8cmd);
}

void SSD1306_writeDataHard(u8 u8data) {
    IIC_writeReg(WRITE_DATA_CMD, u8data);
}
